<template>
    <div>
        ...
        <CardInfo v-for="p in products" :key="p.id"
        :imageUrl="p.image"
        :overline="p.overline"
        :tile="p.name"
        :precio="p.price"
...
const products = [
    ...
    },
    {
        ...
        image: "https://panamericana.vtexassets.com/arquivos/ids/437608-800-auto?v=637869384528100000&width=800&height=auto&aspect=true",
        price: 35.5,
        description:
